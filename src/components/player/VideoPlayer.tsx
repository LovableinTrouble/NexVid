...
export function VideoPlayer({
  ...
  useEffect(() => {
    ...
    stream,
    defaultQuality,
    // explicitly ignoring canTryNextSource, onTryNextSource, playbackSpeed, playerVolume, autoPlay
    // to prevent stream reloading when local or async metadata updates.
