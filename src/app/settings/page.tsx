              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-2">
                  <ProfileStatTile
                    ...
                    sub={`since ${accountCreatedLabel}`}
                  />
                  <ProfileStatTile
                    label="On My List"
                    value={String(profileStats.myListItems)}
                    sub="active titles"
                  />
                  <ProfileStatTile
                    label="Completed"
                  ...
                  <ProfileStatTile
                    label="Watch time"
                    value={formatWatchTime(profileStats.watchTimeMinutes)}
                    sub="total viewed"
                  />
                </div>
