    ...
    <div className="mx-auto max-w-3xl px-6 py-24">
      ...
      <div className="mt-8 space-y-6 text-[13px] leading-relaxed text-text-secondary">
        ...
        <section>
          ...
          <p className="mt-2">
            On this deployment, account authentication uses nickname and password. You are
            responsible for maintaining the security of your account and session tokens.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">
            Accounts may be suspended or blocked where abuse, fraud, or repeated violations are
            detected.
          </p>
        </section>
