...
export const metadata = { title: 'DMCA - Sleepy' };
    ...
    <div className="mx-auto max-w-3xl px-6 py-24">
      ...
      <div className="mt-8 space-y-6 text-[13px] leading-relaxed text-text-secondary">
        <section>
          ...
          <p>
            Sleepy does not host, upload, store, or distribute any media content whatsoever. The
            application is an interface that references third-party sources through provider APIs.
            Stream delivery and availability are controlled by those providers, not by Sleepy.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-inside list-disc space-y-2 text-text-muted">
            <li>Sleepy can run fully in-browser with local storage</li>
        ...
        <section>
          ...
          <p>
            If you believe any third-party content accessible through Sleepy infringes on your
            copyright, please direct your DMCA takedown request to the relevant hosting provider
            that actually serves the content. Sleepy cannot remove content from external hosts.
          </p>
        </section>
